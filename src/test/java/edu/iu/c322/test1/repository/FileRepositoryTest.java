...
class FileRepositoryTest {
    ...
    @Test
    void addQuestion1() throws IOException {
    ...
    @Test
    void addQuestion2() throws IOException {
        Question q = new Question(1,
                "Which word matches the image?",
                "leopard",
    ...
    @Test
    void addQuestion3() throws IOException {
        Question q = new Question(1,
                "Which word matches the image?",
                "lion",
    ...
    void addToDB(Question question) throws IOException {
